                        ...
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                <div class="header-title">
                                    <h4 class="card-title">Update Showtime</h4>
                                </div>
                            </div>
                            <div class="card-body">
                                  <div class="row">
                                                  ...
                                                  <select name="film_id" class="form-control">
                                                         @if (!empty($film))
                                                            ...
                                                            @foreach ($film as $item)
                                                                <option value="{{ $item->id }}" {{ $showTime->film_id == $item->id ? 'selected':'' }}>{{ $item->name }}</option>
                                                            @endforeach
                                                  ...
                                                  <select name="hour_id" class="form-control">
                                                         @if (!empty($hour))
                                                            ...
                                                            @foreach ($hour as $item)
                                                                <option value="{{ $item->id }}" {{ $showTime->hour_id == $item->id ? 'selected':'' }}>{{ $item->time }}</option>
                                                            @endforeach
                                                  ...
                                                  <select name="room_id" class="form-control">
                                                         @if (!empty($room))
                                                            ...
                                                            @foreach ($room as $item)
                                                                <option value="{{ $item->id }}" {{ $showTime->room_id == $item->id ? 'selected':'' }}>{{ $item->name }}</option>
                                                            @endforeach
