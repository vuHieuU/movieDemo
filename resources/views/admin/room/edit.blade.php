...
@section('content')
<form action="/room/update/{{ $room->id }}" method="POST" data-toggle="validator" enctype="multipart/form-data">
    @csrf
    <div class="wrapper">
                                  ...
                                  <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Acreage</label>
                                            <input type="text" class="form-control"
                                                name="acreage" value="{{ $room->acreage }}">
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                  </div> 
                                  <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Content</label>
                                            <input type="text" class="form-control"
                                                name="content" value="{{ $room->content }}">
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                  </div>
